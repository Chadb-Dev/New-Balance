...
abstract class Customweb_Payment_Authorization_Hidden_AbstractWrapper extends Customweb_Payment_Authorization_AbstractAdapterWrapper
implements Customweb_Payment_Authorization_Hidden_IAdapter
{
	/**
	 * @var Customweb_Payment_Authorization_Hidden_IAdapter
	 */
	...
	public function getHiddenFormFields(Customweb_Payment_Authorization_ITransaction $transaction) {
		return $this->adapter->getHiddenFormFields($transaction);
	}
