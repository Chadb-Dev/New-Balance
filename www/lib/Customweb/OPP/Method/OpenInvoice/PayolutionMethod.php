...
//require_once 'Customweb/OPP/Method/OpenInvoiceMethod.php';
//require_once 'Customweb/I18n/Translation.php';


/**
 * @Method(paymentMethods={'OpenInvoice'}, processors={'Payolution'})
 */
class Customweb_OPP_Method_OpenInvoice_PayolutionMethod extends Customweb_OPP_Method_OpenInvoiceMethod
{
