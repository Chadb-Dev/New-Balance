...
var ConfigurableMediaImages = {
    ...
    productImages: {},
    imageObjects: {},
    // Image is set back to the default image when options are selected that are not linked to images e.g. Size
    allowImgSwapFor: ['colour'],
    ...
    updateImage: function(el) {
        ...
        // only swap images for allowed attribute codes
        if (jQuery.inArray(select.attr('data-swatch-code'), this.allowImgSwapFor) != -1) {
