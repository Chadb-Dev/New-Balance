...
Customweb.OPPCw = Class.create({
	initialize : function(hiddenFieldsUrl, visibleFieldsUrl, serverUrl, javascriptUrl, saveShippingUrl, methodCode)
	{
		...
		if (typeof checkout != 'undefined' && typeof Review != 'undefined' && typeof FireCheckout == 'undefined' && typeof IWD == 'undefined' && typeof OneStepCheckoutLoginPopup == 'undefined') {
	...
	createOrderFailureCallback : function(errors, valid)
	{
		...
		$('onestepcheckout-place-order-loading-oppcw').remove();
		var submitelement = $('onestepcheckout-place-order');
