...
namespace Customweb\OPPCw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\OPPCw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\OPPCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
    ...
    public function __construct(
    		...
    		\Customweb\OPPCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    ...
    {
    	parent::_construct();
    	$this->setId('oppcw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('oppcw/customer/aliases', ['_current' => true]);
    }
    ...
    {
    	return __('Open Payment Platform Aliases');
    }
