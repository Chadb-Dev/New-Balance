...
namespace Customweb\OPPCw\Block\Adminhtml\Sales\Order\Invoice\Create;
...
class Components extends \Magento\Framework\View\Element\Template
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_OPPCw::sales/order/invoice/create/components.phtml';
	...
	public function canCaptureNoClose()
	{
		...
		if (!($invoice->getOrder()->getPayment()->getMethodInstance() instanceof \Customweb\OPPCw\Model\Payment\Method\AbstractMethod)) {
			return false;
		}
