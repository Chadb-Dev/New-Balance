...
namespace Customweb\OPPCw\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_OPPCw::oppcw/config/form.phtml';

	/**
	 * @var \Customweb\OPPCw\Model\Config\Structure
	 */
	protected $_formStructure;

	/**
	 * @var \Customweb\OPPCw\Model\Renderer\Adminhtml\BackendForm
	 */
	protected $_backendFormRenderer;

	/**
	 * @param \Magento\Backend\Block\Template\Context $context
	 * @param \Customweb\OPPCw\Model\Config\Structure $formStructure,
	 * @param \Customweb\OPPCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\OPPCw\Model\Config\Structure $formStructure,
			\Customweb\OPPCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer,
			array $data = []
	) {
