...
namespace Customweb\OPPCw\Block\Adminhtml\Checkout\Payment;

class Form extends \Magento\Backend\Block\Widget
{
	/**
	 * @var \Customweb\OPPCw\Model\Renderer\AdminhtmlForm
	 */
	 ...
	 * @param \Customweb\OPPCw\Model\Renderer\Adminhtml\CheckoutForm $formRenderer
	 * @param \Customweb\OPPCw\Model\Authorization\Method\Factory $authorizationMethodFactory
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\OPPCw\Model\Renderer\Adminhtml\CheckoutForm $formRenderer,
	...
	{
		if (!($this->authorizationMethodAdapter instanceof \Customweb\OPPCw\Model\Authorization\Method\AbstractMethod)) {
	 ...
	 * @return \Customweb\OPPCw\Block\Adminhtml\Checkout\Payment\Form
	 */
