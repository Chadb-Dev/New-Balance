...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_OPPCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('oppcw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('oppcw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('oppcw/externalCheckout/registerPost', ['_secure' => true]);
	}
