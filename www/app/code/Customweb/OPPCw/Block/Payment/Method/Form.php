...
namespace Customweb\OPPCw\Block\Payment\Method;
...
class Form extends \Magento\Payment\Block\Form
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_OPPCw::payment/method/form.phtml';
	...
	public function getPaymentForm()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_OPPCw_License::run('ri5mt07v4pbtg9kk', $this, $arguments);
	}

	final public function call_kql2th2t7mg3jkpo() {
	...
	private function getFormRenderer() {
		return new \Customweb\OPPCw\Model\Renderer\CheckoutForm($this->getMethodCode());
	}
