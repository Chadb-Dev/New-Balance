...
define(
    [
        ...
        'Customweb_OPPCw/js/checkout',
        'Customweb_OPPCw/js/authorizationMethod',
        'Customweb_OPPCw/js/storage',
        'Customweb_OPPCw/js/alias',
    ...
    function ($, Component, mageTemplate, url, errorProcessor, Form, AuthorizationMethod, Storage, Alias, placeOrderAction, additionalValidators) {
        ...
        return Component.extend({
            defaults: {
                template: 'Customweb_OPPCw/payment/oppcw_afterpaydirectdebit',
                fieldErrorTemplate: '<div for="<%- id %>" generated="true" class="mage-error" id="<%- id %>-error"><%- message %></div>',
                authorizationUrl: url.build('oppcw/checkout/authorize/'),
                updateAliasUrl: url.build('oppcw/checkout/updateAlias/'),
                updateVisibleFieldsUrl: url.build('oppcw/checkout/updateFields/')
            },
