...
class GuestPost extends \Customweb\OPPCw\Controller\ExternalCheckout
{
	/**
	...
	public function execute()
	{
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\OPPCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
			$data = [
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\OPPCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST))) {
