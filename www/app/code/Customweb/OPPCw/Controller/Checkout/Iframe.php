...
class Iframe extends \Customweb\OPPCw\Controller\Checkout
{
	public function execute()
	{
		$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
		/* @var $authorizationMethodAdapter \Customweb\OPPCw\Model\Authorization\Method\Iframe */
		...
		$resultPage->getLayout()
			->getBlock('customweb_oppcwcheckout_iframe')
