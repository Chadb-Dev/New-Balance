 ...
 *
 */
namespace Customweb\OPPCw\Controller\Checkout;

class UpdateFields extends \Customweb\OPPCw\Controller\Checkout {
	/**
	 *
	...
	/**
	 *
	 * @var \Customweb\OPPCw\Model\Payment\Method\ConfigProvider
	 */
	 ...
	 * @param \Customweb\OPPCw\Model\Payment\Method\ConfigProvider $configProvider
	 */
	public function __construct(\Magento\Framework\App\Action\Context $context, \Magento\Framework\View\Result\PageFactory $resultPageFactory, \Magento\Checkout\Model\Session $checkoutSession, \Magento\Quote\Api\CartRepositoryInterface $quoteRepository, \Customweb\OPPCw\Model\Authorization\TransactionFactory $transactionFactory, \Customweb\OPPCw\Model\Authorization\Method\Factory $authorizationMethodFactory, \Magento\Framework\Controller\Result\JsonFactory $resultJsonFactory, \Magento\Payment\Helper\Data $paymentHelper, \Customweb\OPPCw\Model\Payment\Method\ConfigProvider $configProvider){
