...
namespace Customweb\OPPCw\Controller;
...
abstract class Checkout extends \Magento\Framework\App\Action\Action
{
	 ...
	 */
	protected function handleSuccess(\Customweb\OPPCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 */
	protected function handleFailure(\Customweb\OPPCw\Model\Authorization\Transaction $transaction, $errorMessage)
	{
		$this->_checkoutSession->setLastRealOrderId($transaction->getOrder()->getRealOrderId());
		$this->restoreQuote();

		$this->messageManager->addError($errorMessage);
// 		$this->_checkoutSession->setOPPCwFailureMessage($errorMessage);
