...
namespace Customweb\OPPCw\Controller\Adminhtml\Checkout;

class UpdateAlias extends \Customweb\OPPCw\Controller\Adminhtml\Checkout
{
	/**
	...
	public function __construct(
			...
			\Customweb\OPPCw\Model\Payment\Method\ConfigProvider $configProvider
	) {
	...
	public function execute()
	{
		...
		/* @var $block \Customweb\OPPCw\Block\Adminhtml\Checkout\Payment\Form */
		$block = $this->_layout->createBlock('Customweb\OPPCw\Block\Adminhtml\Checkout\Payment\Form');
