...
namespace Customweb\OPPCw\Controller\Adminhtml;
...
abstract class Transaction extends \Magento\Backend\App\Action
{
	...
	protected function _initAction()
	{
		...
		$resultPage->setActiveMenu('Customweb_OPPCw::transactions');
		$resultPage->addBreadcrumb(__('Sales'), __('Sales'));
		$resultPage->addBreadcrumb('Open Payment Platform', 'Open Payment Platform');
		$resultPage->addBreadcrumb(__('Open Payment Platform Transactions'), __('Open Payment Platform Transactions'));
		return $resultPage;
	}
	 ...
	 *
	 * @return \Customweb\OPPCw\Model\Authorization\Transaction|false
	 */
	protected function _initTransaction()
	{
		...
		$this->_coreRegistry->register('oppcw_transaction', $transaction);
		return $transaction;
	}

	protected function _isAllowed()
	{
		return $this->_authorization->isAllowed('Customweb_OPPCw::transactions');
	}
}