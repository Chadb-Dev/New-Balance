...
namespace Customweb\OPPCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\OPPCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_oppcw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_oppcw_external_checkout_context', 'context_id');
    }
