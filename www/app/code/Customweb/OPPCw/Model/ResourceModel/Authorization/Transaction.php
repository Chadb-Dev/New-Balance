...
namespace Customweb\OPPCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\OPPCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_oppcw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\OPPCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_oppcw_transaction', 'entity_id');
    }
