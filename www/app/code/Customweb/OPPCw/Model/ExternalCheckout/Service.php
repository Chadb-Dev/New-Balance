...
class Service implements \Customweb_Payment_ExternalCheckout_ICheckoutService
{
	...
	/**
	 * @var \Customweb\OPPCw\Helper\ExternalCheckout
	 */
	protected $_helper;
	...
	/**
	 * @var \Customweb\OPPCw\Model\Authorization\OrderContextFactory
	 */
	 ...
	 * @param \Customweb\OPPCw\Helper\ExternalCheckout $helper
	 ...
	 * @param \Customweb\OPPCw\Model\Authorization\OrderContextFactory $orderContextFactory
	 */
	public function __construct(
			...
			\Customweb\OPPCw\Helper\ExternalCheckout $helper,
			...
			\Customweb\OPPCw\Model\Authorization\OrderContextFactory $orderContextFactory
	) {
	...
	/**
	 * @param \Customweb\OPPCw\Model\DependencyContainer $container
	 * @return \Customweb\OPPCw\Model\ExternalCheckout\Service
	 */
	public function setContainer(\Customweb\OPPCw\Model\DependencyContainer $container)
	{
	...
	{
		if (!($context instanceof \Customweb\OPPCw\Model\ExternalCheckout\Context)) {
			throw new \Customweb_Core_Exception_CastException('Customweb\OPPCw\Model\ExternalCheckout\Context');
		}
	...
	public function authenticate(\Customweb_Payment_ExternalCheckout_IContext $context, $emailAddress, $successUrl)
	{
		...
		if ($this->_checkoutHelper->isAllowedGuestCheckout($context->getQuote())
				&& $this->_scopeConfig->getValue('oppcw/shop/external_checkout_account_creation') == 'skip_selection') {
			...
			$context->setRegisterMethod(\Customweb\OPPCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
		...
		$context->save();
		return \Customweb_Core_Http_Response::redirect($context->getQuote()->getStore()->getUrl('oppcw/externalCheckout/login', ['_secure' => true]));
	}
	...
	public function renderShippingMethodSelectionPane(\Customweb_Payment_ExternalCheckout_IContext $context, $errorMessages)
	{
		...
		return $this->_layoutFactory->create()->createBlock('Customweb\OPPCw\Block\ExternalCheckout\ShippingMethods')
			->setContext($context)
	...
	public function renderReviewPane(\Customweb_Payment_ExternalCheckout_IContext $context, $renderConfirmationFormElements, $errorMessage)
	{
		...
		$layout->getUpdate()->load(['oppcw_externalcheckout_review']);
		$layout->generateXml();
		$layout->generateElements();
		$layout->getBlock('customweb_oppcw_externalcheckout_review')
			->setContext($context)
	...
	public function createOrder(\Customweb_Payment_ExternalCheckout_IContext $context)
	{
		...
		try {
			...
			/* @var $transaction \Customweb\OPPCw\Model\Authorization\Transaction */
			$transaction = $this->_coreRegistry->registry('oppcw_transaction');
