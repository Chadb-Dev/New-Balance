...
namespace Customweb\OPPCw\Model\ExternalCheckout;

/**
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\OPPCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	...
	/**
	 * @var \Customweb\OPPCw\Helper\InvoiceItem
	 */
	protected $_invoiceItemHelper;

	/**
	 * @var \Customweb\OPPCw\Helper\FoomanSurcharge
	 */
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_oppcw_external_checkout_context';
	...
	/**
	 * @var \Customweb\OPPCw\Model\Payment\Method\AbstractMethod
	 */
	 ...
	 * @param \Customweb\OPPCw\Helper\InvoiceItem $invoiceItemHelper
	 * @param \Customweb\OPPCw\Helper\FoomanSurcharge $foomanSurchargeHelper
	...
	public function __construct(
			...
			\Customweb\OPPCw\Helper\InvoiceItem $invoiceItemHelper,
			\Customweb\OPPCw\Helper\FoomanSurcharge $foomanSurchargeHelper,
    ...
    protected function _construct() {
        $this->_init('Customweb\OPPCw\Model\ResourceModel\ExternalCheckout\Context');
    }
     ...
     *
     * @param int $quoteId
     * @return \Customweb\OPPCw\Model\ExternalCheckout\Context
     */
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\OPPCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\OPPCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\OPPCw\Model\ExternalCheckout\Context
     */
    public function setPaymentMethod($paymentMethod)
    {
    	if ($paymentMethod instanceof \Customweb\OPPCw\Model\Payment\Method\AbstractMethod) {
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\OPPCw\Model\Payment\Method\AbstractMethod) {
			$data = [
