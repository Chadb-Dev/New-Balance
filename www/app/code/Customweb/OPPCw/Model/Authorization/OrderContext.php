...
class OrderContext implements \Customweb_Payment_Authorization_IOrderContext
{
	 ...
	 * @param \Customweb\OPPCw\Model\Payment\Method\AbstractMethod|string $paymentMethod
	 * @throws \Exception
	 */
	...
	private function assembleDataFromQuote(
		...
		$checkoutId = $checkoutSession->getOPPCwCheckoutId();
		if(empty($checkoutId)){
			$checkoutId = \Customweb_Core_Util_Rand::getUuid();
			$checkoutSession->setOPPCwCheckoutId($checkoutId);
		}
