...
class Quote extends AbstractContext
{
	...
	public function __construct(
			...
			\Customweb\OPPCw\Model\Payment\Method\AbstractMethod $paymentMethod = null,
		...
		if (!($quote instanceof \Magento\Quote\Model\Quote)) {
			if ($this->_coreRegistry->registry('oppcwcheckout_moto')) {
	...
	{
		if (!($this->orderContext instanceof \Customweb\OPPCw\Model\Authorization\OrderContext)) {
	...
	public function isMoto()
	{
		return $this->getQuote()->getIsSuperMode()
			|| $this->_coreRegistry->registry('oppcwcheckout_moto');
	}
}