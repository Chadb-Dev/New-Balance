...
class Widget extends AbstractMethod
{
	...
	{
		return $this->getContext()->getTransaction()->getStore()->getUrl('oppcw/checkout/widget', ['_secure' => true]);
	}
	...
	{
		$result = $this->getAdapter()->getWidgetHTML($this->getContext()->getTransaction()->getTransactionObject(), $this->getContext()->getParameters());
