...
class Factory
{
     ...
     */
    public function create(\Customweb\OPPCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\OPPCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\OPPCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\OPPCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\OPPCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\OPPCw\Model\Authorization\Method\Context\Factory
     */
