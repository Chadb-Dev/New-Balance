 ...
 *
 */
namespace Customweb\OPPCw\Model\Payment\Method;
...
class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod implements \Customweb_Payment_Authorization_IPaymentMethod
{
	...
	/**
	 *
	 * @var \Customweb\OPPCw\Model\Configuration
	 */
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'Customweb\OPPCw\Block\Payment\Method\Form';
	 ...
	 * @var string
	 */
	protected $_infoBlockType = 'Customweb\OPPCw\Block\Payment\Method\Info';
	 ...
	 * @param \Customweb\OPPCw\Model\Configuration $configuration
	...
	public function __construct(
			...
			\Customweb\OPPCw\Model\Configuration $configuration,
	...
	public function getOrderPlaceRedirectUrl()
	{
		...
		$transactionId = null;
		$transaction = $this->_registry->registry('oppcw_transaction');
		if ($transaction instanceof \Customweb\OPPCw\Model\Authorization\Transaction) {
			$transactionId = $transaction->getId();
		}
		return $quote->getStore()->getUrl('oppcw/checkout/error', [
			'_secure' => true,
	...
	public function validate()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_OPPCw_License::run('rcjear83hr4t43ke', $this, $arguments);
	}

	final public function call_1mrbjieclsrroreq() {
	 ...
	 * @return \Customweb\OPPCw\Model\Payment\Method\AbstractMethod
	 */
	...
	public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		$transaction = $this->_registry->registry('oppcw_authorization_transaction');
		if ($transaction instanceof \Customweb\OPPCw\Model\Authorization\Transaction) {
	...
	public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		if ($transaction->getId()) {
			$invoice = $this->_registry->registry('oppcw_invoice');
	...
	private function captureItems(\Customweb\OPPCw\Model\Authorization\Transaction $transaction, $items = [])
	{
