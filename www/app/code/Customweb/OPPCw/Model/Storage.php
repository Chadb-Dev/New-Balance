 ...
 * @method \Customweb\OPPCw\Model\Storage setKeySpace(string $value)
 * @method string getKeyName()
 * @method \Customweb\OPPCw\Model\Storage setKeyName(string $value)
 * @method string getKeyValue()
 * @method \Customweb\OPPCw\Model\Storage setKeyValue(string $value)
 */
class Storage extends \Magento\Framework\Model\AbstractModel
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_oppcw_storage';
    ...
    {
        $this->_init('Customweb\OPPCw\Model\ResourceModel\Storage');
    }
