...
namespace Customweb\OPPCw\Model\Alias;
...
class Handler
{
	 ...
	 */
	public function getAliasTransactions(\Customweb\OPPCw\Model\Authorization\OrderContext $orderContext)
	{
	 ...
	 */
	public function removeSimilarAliases(\Customweb\OPPCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws \Exception
	 */
	public function removeAlias(\Customweb\OPPCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws Exception
	 */
	public function deactivateAlias(\Customweb\OPPCw\Model\Authorization\Transaction $transaction)
	{
		$transaction->setAliasActive(false);
		$transaction->save();
	}
