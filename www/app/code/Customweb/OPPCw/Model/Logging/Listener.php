...
namespace Customweb\OPPCw\Model\Logging;
...
class Listener implements \Customweb_Core_Logger_IListener {
	 ...
	 * @var string
	 */
	protected $fileName = '/var/log/oppcw.log';
	...
	private function isLevelActive($level) {
		switch ($this->_scopeConfig->getValue('oppcw/logging/level')) {
			case 'debug':
				return true;
			case 'info':
