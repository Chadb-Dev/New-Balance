...
namespace Customweb\OPPCw\Model\Renderer;
...
class AbstractForm extends \Customweb_Form_Renderer
{
	...
	protected function renderRegisterCallback($jsFunctionPostfix){
		...
		$registerJs = "require(['jquery', 'domReady', 'Customweb_OPPCw/js/form'], function($, domReady, Form){\n";
	...
	{
		$eventJs = "require(['jquery', 'domReady', 'Customweb_OPPCw/js/form', 'mage/template'], function($, domReady, Form, mageTemplate){\n";
