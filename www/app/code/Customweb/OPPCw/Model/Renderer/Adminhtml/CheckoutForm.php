...
namespace Customweb\OPPCw\Model\Renderer\Adminhtml;

class CheckoutForm extends \Customweb\OPPCw\Model\Renderer\AbstractForm
{
	/**
	...
	public function __construct(
		...
		$this->setControlCssClassResolver(new \Customweb\OPPCw\Model\Renderer\Adminhtml\ControlCssClassResolver());

		$this->setFormCssClass('oppcw_form');
