...
class TransactionRepository implements \Customweb\OPPCw\Api\TransactionRepositoryInterface
{
	/**
    ...
    /**
     * @var \Customweb\OPPCw\Api\Data\TransactionInterfaceFactory
     */
	 ...
	 * @param \Customweb\OPPCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory
	...
	public function __construct(
			...
			\Customweb\OPPCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory,
	...
	public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
	{
		...
		/** @var \Customweb\OPPCw\Model\ResourceModel\Authorization\Transaction\Collection $collection */
	 ...
	 *
	 * @return \Customweb\OPPCw\Api\Data\TransactionInterface
	 */
	protected function getDataModel(\Customweb\OPPCw\Model\Authorization\Transaction $transaction)
	{
		$transactionDataObject = $this->_transactionDataFactory->create();
		$this->_dataObjectHelper->populateWithArray(
				$transactionDataObject,
				$this->extractTransactionData($transaction),
				'\Customweb\OPPCw\Api\Data\TransactionInterface'
		);
		return $transactionDataObject;
	}

	private function extractTransactionData(\Customweb\OPPCw\Model\Authorization\Transaction $transaction)
	{
		...
		$data[\Customweb\OPPCw\Api\Data\TransactionInterface::TRANSACTION_DATA] = $transactionData;
		return $data;
	}
