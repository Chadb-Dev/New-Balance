...
namespace Customweb\OPPCw\Observer\ExternalCheckout;
...
{
	/**
	 * @var \Customweb\OPPCw\Model\ExternalCheckout\Widget\Collection
	 */
	protected $_widgetCollection;

	/**
	 * @param \Customweb\OPPCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	 */
	public function __construct(
			\Customweb\OPPCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	) {
