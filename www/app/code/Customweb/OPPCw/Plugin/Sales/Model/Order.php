...
namespace Customweb\OPPCw\Plugin\Sales\Model;
...
class Order
{
	...
	public function afterCanFetchPaymentReviewUpdate(\Magento\Sales\Model\Order $subject, $result)
	{
		...
		if ($subject->getPayment() instanceof \Magento\Sales\Model\Order\Payment
	    	&& $subject->getPayment()->getMethodInstance() instanceof \Customweb\OPPCw\Model\Payment\Method\AbstractMethod
			&& $this->_coreRegistry->registry('oppcw_order_view')) {
