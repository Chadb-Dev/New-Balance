...
namespace Customweb\OPPCw\Helper;
...
class ExternalCheckout extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function validateCustomerData(\Magento\Quote\Model\Quote $quote, array $data, $registerMethod)
	{
		...
		if ($registerMethod == \Customweb\OPPCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER) {
	...
	/**
	 * @param \Customweb\OPPCw\Model\ExternalCheckout\Context $context
	 * @return \Magento\Sales\Model\Order
	 */
	public function saveOrder(\Customweb\OPPCw\Model\ExternalCheckout\Context $context)
	{
		$context->getQuote()->collectTotals()->save();

		$isNewCustomer = false;
		switch ($context->getRegisterMethod()) {
			case \Customweb\OPPCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST:
				$this->prepareGuestQuote($context);
				break;
			case \Customweb\OPPCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER:
	 ...
	 * @param \Customweb\OPPCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareGuestQuote(\Customweb\OPPCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\OPPCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareNewCustomerQuote(\Customweb\OPPCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\OPPCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareCustomerQuote(\Customweb\OPPCw\Model\ExternalCheckout\Context $context)
	{
		$billing = $context->getQuote()->getBillingAddress();
		$shipping = $context->getQuote()->isVirtual() ? null : $context->getQuote()->getShippingAddress();
	 ...
	 * @param \Customweb\OPPCw\Model\ExternalCheckout\Context $context
	 */
	private function involveNewCustomer(\Customweb\OPPCw\Model\ExternalCheckout\Context $context)
	{
		$customer = $context->getQuote()->getCustomer();
