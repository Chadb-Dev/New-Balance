...
class IWD_StoreLocator_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    public function init($attributeName, $imageFile = null)
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('storelocator/image'));
        ...
        if ($imageFile) {
            ...
            $this->setImageFile($this->getPlaceholder());
        }
    ...
    public function getPlaceholder()
    {
        if (!$this->_placeholder) {
            ...
            if (!empty($p)) {
                $this->_placeholder = 'gmmarker/' . $p;
            } else {
                $this->_placeholder = 'iwd/storelocator/placeholder/placeholder.png';
            }
        }
    ...
    public function __toString()
    {
        try {
            ...
            // empty image
            $url = Mage::getBaseUrl('media') . $this->getPlaceholder();
        }
