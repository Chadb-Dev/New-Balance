...
class IWD_StoreLocator_Model_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    public function setBaseFile($file)
    {
        ...
        if (!$file) {
            ...
            $p = Mage::getStoreConfig('storelocator/global/placeholder');
            if (!empty($p)) {
                $configPlaceholder = 'gmmarker/' . $p;
            } else {
                $configPlaceholder = '/iwd/storelocator/placeholder/placeholder.png1';
            }
            ...
            if ($isConfigPlaceholder && $this->_fileExists($baseDir . $configPlaceholder)) {
                ...
                $skinPlaceholder = "/iwd/storelocator/placeholder/placeholder.png";
        ...
        $path = array(
            Mage::getBaseDir('media') . DS . 'iwd' . DS . 'storelocator',
            'cache',
        ...
        $this->_newFile = $file; // the $file contains heading slash
    ...
    protected function _getWatermarkFilePath()
    {
        ...
        $baseDir = Mage::getBaseDir('media') . DS . 'iwd' . DS . 'storelocator';
    ...
    {
        $directory = Mage::getBaseDir('media') . DS . 'iwd' . DS . 'storelocator' . DS . 'cache' . DS;
