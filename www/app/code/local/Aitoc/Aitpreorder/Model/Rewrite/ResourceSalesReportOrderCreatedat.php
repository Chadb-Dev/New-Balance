 ...
 */
class Aitoc_Aitpreorder_Model_Rewrite_ResourceSalesReportOrderCreatedat extends Mage_Sales_Model_Resource_Report_Order_Createdat
{
	protected function _aggregateByField($aggregationField, $from, $to)
    {
        ...
        try {
            ...
            $columns = array(
                ...
                'period'                         => $periodExpr,
                'store_id'                       => 'o.store_id',
                'order_status'                   => 'o.status_preorder',// -> Aitoc modification
            ...
            $select->group(array(
                $periodExpr,
                'o.store_id',
                'o.status_preorder',// -> Aitoc modification
            ));
