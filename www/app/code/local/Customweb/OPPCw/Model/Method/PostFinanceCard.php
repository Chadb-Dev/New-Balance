...
class Customweb_OPPCw_Model_Method_PostFinanceCard extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_postfinancecard';
	protected $paymentMethodName = 'postfinancecard';
