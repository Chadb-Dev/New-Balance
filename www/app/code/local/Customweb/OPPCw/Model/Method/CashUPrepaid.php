...
class Customweb_OPPCw_Model_Method_CashUPrepaid extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_cashuprepaid';
	protected $paymentMethodName = 'cashuprepaid';
