...
class Customweb_OPPCw_Model_Method_PayolutionElv extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_payolutionelv';
	protected $paymentMethodName = 'payolutionelv';
