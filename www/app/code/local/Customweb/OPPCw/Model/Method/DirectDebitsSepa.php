...
class Customweb_OPPCw_Model_Method_DirectDebitsSepa extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_directdebitssepa';
	protected $paymentMethodName = 'directdebitssepa';
