...
class Customweb_OPPCw_Model_Method_Prepayment extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_prepayment';
	protected $paymentMethodName = 'prepayment';
