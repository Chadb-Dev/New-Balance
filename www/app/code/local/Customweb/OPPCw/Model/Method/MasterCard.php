...
class Customweb_OPPCw_Model_Method_MasterCard extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_mastercard';
	protected $paymentMethodName = 'mastercard';
