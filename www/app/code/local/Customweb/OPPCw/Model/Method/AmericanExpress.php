...
class Customweb_OPPCw_Model_Method_AmericanExpress extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_americanexpress';
	protected $paymentMethodName = 'americanexpress';
