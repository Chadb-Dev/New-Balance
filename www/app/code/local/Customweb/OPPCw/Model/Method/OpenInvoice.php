...
class Customweb_OPPCw_Model_Method_OpenInvoice extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_openinvoice';
	protected $paymentMethodName = 'openinvoice';
