...
class Customweb_OPPCw_Model_Method_ChinaUnionpay extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_chinaunionpay';
	protected $paymentMethodName = 'chinaunionpay';
