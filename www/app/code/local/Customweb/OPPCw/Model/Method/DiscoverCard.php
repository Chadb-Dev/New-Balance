...
class Customweb_OPPCw_Model_Method_DiscoverCard extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_discovercard';
	protected $paymentMethodName = 'discovercard';
