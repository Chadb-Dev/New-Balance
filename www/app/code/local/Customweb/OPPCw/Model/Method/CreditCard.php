...
class Customweb_OPPCw_Model_Method_CreditCard extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_creditcard';
	protected $paymentMethodName = 'creditcard';
