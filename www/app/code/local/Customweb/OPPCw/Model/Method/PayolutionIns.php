...
class Customweb_OPPCw_Model_Method_PayolutionIns extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_payolutionins';
	protected $paymentMethodName = 'payolutionins';
