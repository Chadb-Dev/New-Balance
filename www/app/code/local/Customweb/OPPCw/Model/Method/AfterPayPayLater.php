...
class Customweb_OPPCw_Model_Method_AfterPayPayLater extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_afterpaypaylater';
	protected $paymentMethodName = 'afterpaypaylater';
