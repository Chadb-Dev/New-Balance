...
class Customweb_OPPCw_Model_Method_AfterPayDirectDebit extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_afterpaydirectdebit';
	protected $paymentMethodName = 'afterpaydirectdebit';
