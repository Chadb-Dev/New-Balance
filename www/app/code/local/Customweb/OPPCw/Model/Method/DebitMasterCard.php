...
class Customweb_OPPCw_Model_Method_DebitMasterCard extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_debitmastercard';
	protected $paymentMethodName = 'debitmastercard';
