...
class Customweb_OPPCw_Model_Method_KlarnaInvoice extends Customweb_OPPCw_Model_Method
{
	protected $_code = 'oppcw_klarnainvoice';
	protected $paymentMethodName = 'klarnainvoice';
