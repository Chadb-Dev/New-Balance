...
class Customweb_OPPCw_Model_Transaction_Api extends Mage_Api_Model_Resource_Abstract
{
    ...
    protected function prepareEntry(Customweb_OPPCw_Model_Transaction $transaction, $attributes = null)
    {
    	...
    	if (is_string($transaction->getTransactionObject())) {
    		$transaction->setTransactionObject(Mage::helper('OPPCw')->unserialize($transaction->getTransactionObject()));
    	}
