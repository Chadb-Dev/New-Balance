 ...
 * @Bean
 */
class Customweb_OPPCw_Model_UpdateHandler implements Customweb_Payment_Update_IHandler
{
	public function getContainer() {
		return Mage::helper('OPPCw')->createContainer();
	}
	...
	public function log($message, $type) {
		...
		Mage::helper('OPPCw')->log($message, $level);
	}

	public function getScheduledTransactionIds() {
		$resource = Mage::getSingleton('core/resource');
		$readConnection = $resource->getConnection('core_read');
		$query = 'SELECT transaction_id FROM ' . $resource->getTableName('oppcw/transaction')
