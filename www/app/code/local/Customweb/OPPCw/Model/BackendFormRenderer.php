...
class Customweb_OPPCw_Model_BackendFormRenderer extends Customweb_Form_Renderer
{
	private $formId = null;
	...
	public function __construct()
	{
		...
		$this->setControlCssClassResolver(Mage::getModel('oppcw/controlCssClassResolver'));
	...
	{
		if (Mage::getModel('oppcw/configurationAdapter')->getStoreHierarchy() == null) {
			return '';
		}
	...
	protected function renderElementScopeControl(Customweb_Form_IElement $element)
	{
		...
		$output .= '<label for="' . $scopeControlId . '">' . Mage::helper('OPPCw')->__('Use Default') . '</label>';
		return $output;
	}
	...
	{
		$storeHierarchy = Mage::getModel('oppcw/configurationAdapter')->getStoreHierarchy();
