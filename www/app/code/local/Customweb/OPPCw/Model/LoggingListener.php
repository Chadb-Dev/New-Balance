 ...
 *
 */
class Customweb_OPPCw_Model_LoggingListener implements Customweb_Core_Logger_IListener {
	...
	public function addLogEntry($loggerName, $level, $message, Exception $e = null, $object = null){
		...
		Mage::log($content, $this->getLogLevel($level), 'oppcw.log', true);
	}
	...
	private function isLevelActive($level){
		switch (Mage::getStoreConfig('oppcw/general/logging_level')) {
			case 'debug':
				return true;
			case 'info':
