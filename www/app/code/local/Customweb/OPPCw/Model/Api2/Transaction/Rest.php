...
class Customweb_OPPCw_Model_Api2_Transaction_Rest extends Customweb_OPPCw_Model_Api2_Transaction
{
	...
	{
		$transaction = Mage::getModel('oppcw/transaction')->load($id);
	...
	protected function prepareEntry(Customweb_OPPCw_Model_Transaction $transaction)
	{
