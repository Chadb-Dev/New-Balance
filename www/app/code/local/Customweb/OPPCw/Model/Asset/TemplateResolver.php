...
class Customweb_OPPCw_Model_Asset_TemplateResolver implements Customweb_Asset_IResolver
{
	public function resolveAssetStream($identifier) {
		$filePath = $this->getTemplateFilePath($identifier);
	...
	private function getTemplateFilePath($identifier) {
		return Mage::getSingleton('core/design_package')->getTemplateFilename('customweb/oppcw/assets/' . $identifier);
	}
}