...
class Customweb_OPPCw_Model_Asset_SkinResolver implements Customweb_Asset_IResolver
{
	...
	private function getSkinFilePath($identifier) {
		return Mage::getSingleton('core/design_package')->getFilename('customweb/oppcw/assets/' . $identifier, array(
			'_type' => 'skin'
		));
	}
	
	private function getSkinUrl($identifier) {
		return Mage::getSingleton('core/design_package')->getSkinUrl('customweb/oppcw/assets/' . $identifier);
	}
}