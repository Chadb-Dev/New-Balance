 ...
 * @Bean
 */
class Customweb_OPPCw_Model_TransactionHandler extends Mage_Core_Model_Abstract implements Customweb_Payment_ITransactionHandler
{
	private $cache = array(
	 ...
	 * @return Customweb_OPPCw_Model_Transaction|null
	 */
	private function loadTransaction($value, $field, $useCache) {
		...
		$transaction = Mage::getModel('oppcw/transaction')->load($value, $field);
