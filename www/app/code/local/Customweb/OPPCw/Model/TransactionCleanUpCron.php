 ...
 */
class Customweb_OPPCw_Model_TransactionCleanUpCron {
	...
	public function cleanUp() {
		...
		$failedCollection = Mage::getModel('oppcw/transaction')->getCollection()
		...
		$pendingCollection = Mage::getModel('oppcw/transaction')->getCollection()
		...
		$noStatusCollection = Mage::getModel('oppcw/transaction')->getCollection()
