 ...
 * 
 */
class Customweb_OPPCw_ConfigoppcwController extends Mage_Adminhtml_Controller_Action {

	protected function _isAllowed(){
		return Mage::getSingleton('admin/session')->isAllowed('system/oppcw');
	}
	...
	public function indexAction(){
		...
		if (!empty($forms)){
			...
			$this->_title('Open Payment Platform');
			
			$this->_setActiveMenu('system/oppcw');
	...
	public function viewAction(){
		...
		if (!empty($machineName)) {
			...
			$this->_addContent($this->getLayout()->createBlock('oppcw/adminhtml_backendForm_form')->setForm($form));
		}
	...
	private function updateStoreHierarchy(){
		...
		Customweb_OPPCw_Model_ConfigurationAdapter::setStoreHierarchy($storeHierarchy);
	}
	...
	private function getFormAdapter(){
		$container = Mage::helper('OPPCw')->createContainer();
