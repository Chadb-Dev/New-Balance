...
class Customweb_OPPCw_MotooppcwController extends Mage_Adminhtml_Controller_Action
{
	
	protected function _isAllowed()
	{
		return Mage::getSingleton('admin/session')->isAllowed('sales/oppcw/oppcw_moto');
	}
	...
	public function processAction()
	{
		...
		$this->getLayout()
			->getBlock('head')
			->addCss('css/oppcw.css');
		$this->getLayout()
			->getBlock('content')
			->append($this->getLayout()
				->createBlock('oppcw/moto'));
