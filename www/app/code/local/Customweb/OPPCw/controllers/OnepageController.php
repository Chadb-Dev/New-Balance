 ...
 *
 */
class Customweb_OPPCw_OnepageController extends Mage_Checkout_Controller_Action {

	/**
	 *
	 * @return Customweb_OPPCw_OnepageController
	 */
	...
	protected function _getPaymentMethodsHtml(){
		...
		foreach($layout->getAllBlocks() as $block){
			if($block instanceof Customweb_OPPCw_Block_Form){
