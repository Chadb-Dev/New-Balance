...
class Customweb_OPPCw_ProcessController extends Customweb_OPPCw_Controller_Action
{
	public function processAction()
	{
		...
		$adapter = Mage::getModel('oppcw/endpointAdapter');
	...
	public function dummyAction()
	{
		...
		$this->getLayout()->getBlock('content')->append(
			$this->getLayout()->createBlock('oppcw/dummy')
		);
	...
	public function getVisibleFieldsAction()
	{
		...
		if($payment != null){
			...
			$this->getHelper()->log("OPPCw : ProcessController::getVisibleFieldsAction() Could not find payment method '" . $_REQUEST['payment_method']);
			$html = Mage::helper("OPPCw")->__("Technical issue: This payment methods is not available at the moment.");
		}
