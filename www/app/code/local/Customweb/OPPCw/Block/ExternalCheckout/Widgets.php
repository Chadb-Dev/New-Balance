...
class Customweb_OPPCw_Block_ExternalCheckout_Widgets extends Mage_Core_Block_Template
{
    ...
    public function getWidgets()
    {
    	if (self::$_widgets == null) {
			self::$_widgets = Mage::getModel('oppcw/externalCheckoutWidgets')->getAllWidgets();
    	}
