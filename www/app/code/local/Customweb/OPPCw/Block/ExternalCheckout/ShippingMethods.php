...
class Customweb_OPPCw_Block_ExternalCheckout_ShippingMethods extends Mage_Core_Block_Template
{
	private $_context;
	...
	{
		parent::_construct();
		$this->setTemplate('customweb/oppcw/external_checkout/shipping-methods.phtml');
	}
